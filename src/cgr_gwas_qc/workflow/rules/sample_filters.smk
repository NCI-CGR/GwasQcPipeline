...
# Sample Concordance
################################################################################
"""Validate known replicates and identify unknown highly similar samples.
...
rule plink_ibd:
    ...
    params:
        ...
        out_prefix="sample_filters/ibd/samples",
        ibd_min=cfg.config.software_params.ibd_pi_hat_min,
        ibd_max=cfg.config.software_params.ibd_pi_hat_max,
    output:
        genome="sample_filters/ibd/samples.genome",
        nosex="sample_filters/ibd/samples.nosex",
    log:
        "sample_filters/ibd/samples.log",
    envmodules:
        cfg.envmodules("plink2"),
    conda:
        cfg.conda("plink2.yml")
